    ...
    <div className="bg-black text-white">
      <header className="mx-auto max-w-screen-2xl px-4 xm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-3 sm:py-4">
          <div>
            <div className="text-2xl sm:text-4xl font-bold cursor-default">
              CATALOG
            </div>
          </div>
          ...
          <div>
            ...
            >
              ...
              <span className="absolute text-xs top-[11px] right-[18px] sm:top-[10px] sm:right-[20px] sm:text-sm text-black font-semibold">
                {totalProducts}
              </span>
            </button>
          </div>
